...
/**
 * Removes navigation and header meta boxes from Genesis Theme Settings admin page.
 *
 * The theme supports a custom logo and navigation so those settings are not useful.
 *
 * @since 1.0.0
 */
function authority_remove_genesis_metaboxes() {
...
add_filter( 'genesis_seo_title', 'authority_header_title', 10, 3 );
/**
 ...
 */
function authority_header_title( $title, $inside, $wrap ) {
	if ( has_custom_logo() ) {
